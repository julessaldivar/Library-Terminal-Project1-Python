...
from Library_class_Book import Media
from Library_class_Book import Movie
...
def add_movie(list):
    ...
    print(f"Great! You've added {new_movie.title} directed by {new_movie.director} to the library. We appreciate your donation.")